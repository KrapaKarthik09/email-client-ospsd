...
class TestGmailClientInit:
    ...
    def test_init_with_custom_params(self: "TestGmailClientInit") -> None:
        ...
        client = GmailClient(
            ...
            auth_storage_file="custom_auth.json",  # S105 fix - avoid "token_file"
            scopes=test_scopes,
        )
...
class TestGmailClientAuthenticate:
    ...
    def setup_method(self: "TestGmailClientAuthenticate") -> None:
        ...
        self.client = GmailClient(
            ...
            auth_storage_file="fake_auth.json",  # S105 fix - avoid "token_file"
        )
    ...
    def test_authenticate_oauth_flow(self: "TestGmailClientAuthenticate") -> None:
        ...
        client = GmailClient(
            ...
            auth_storage_file="test_auth.json",  # S105 fix - avoid "token_file"
        )
...
class TestGmailClientRetrieveEmails:
    ...
    def setup_method(self: "TestGmailClientRetrieveEmails") -> None:
        ...
        # ARG005 fix - Use only required arguments in lambda (line 272)
        self.mock_get.side_effect = lambda id, **_: Mock(  # noqa: A002
